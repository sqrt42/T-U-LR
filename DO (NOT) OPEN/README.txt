...
там, где скриншоты в любом случае придётся заменять, я их удалил; в местах, где их надо вставить, есть плейсхолдеры "[screenshot]". Прошу всех, кто дополняет архив, следовать этим правилам: так всем будет проще ориентироватся в отчетах.
